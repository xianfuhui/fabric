...
#
# See https://github.com/xianfuhui/fabric/blob/master/docs/dev-setup/install.md#building-outside-of-vagrant-
#
...
if [ ! -d "$GOPATH/src/github.com/xianfuhui/fabric" ]
then
    echo "Ensure fabric code is under $GOPATH/src/github.com/xianfuhui/fabric"
    exit
fi
