...
`configtx.yaml`. You can look at a [sample `configtx.yaml` file here](http://github.com/xianfuhui/fabric/blob/release-1.4/sampleconfig/configtx.yaml).
...
followed by a string. To see what this looks like, reference this [sample configtx.yaml file](https://github.com/xianfuhui/fabric/blob/release-1.2/sampleconfig/configtx.yaml).
