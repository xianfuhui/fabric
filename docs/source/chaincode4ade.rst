...
Every chaincode program must implement the ``Chaincode`` interface:
  ...
  - `Go <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#Chaincode>`__
...
The other interface in the chaincode "shim" APIs is the ``ChaincodeStubInterface``:
  ...
  - `Go <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#ChaincodeStubInterface>`__
...
`Chaincode interface <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#Chaincode>`_
...
`peer protobuf package <https://godoc.org/github.com/xianfuhui/fabric/protos/peer>`_.
...
.. code:: go
    ...
    import (
    	...
    	"github.com/xianfuhui/fabric/core/chaincode/shim"
...
`ChaincodeStubInterface.GetStringArgs <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#ChaincodeStub.GetStringArgs>`_
...
`ChaincodeStubInterface.PutState <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#ChaincodeStub.PutState>`_
...
`ChaincodeStubInterface.GetFunctionAndParameters <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#ChaincodeStub.GetFunctionAndParameters>`_
...
the `ChaincodeStubInterface.PutState <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#ChaincodeStub.PutState>`_
and `ChaincodeStubInterface.GetState <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#ChaincodeStub.GetState>`_
...
`shim.Start <https://godoc.org/github.com/xianfuhui/fabric/core/chaincode/shim#Start>`_
...
.. code:: bash
  ...
  go get -u github.com/xianfuhui/fabric/core/chaincode/shim
  go build
...
See the `client identity (CID) library documentation <https://github.com/xianfuhui/fabric/blob/release-1.4/core/chaincode/shim/ext/cid/README.md>`_
for more details.
...
the `entities extension <https://github.com/xianfuhui/fabric/tree/release-1.4/core/chaincode/shim/ext/entities>`__
...
`Encc Example <https://github.com/xianfuhui/fabric/tree/release-1.4/examples/chaincode/go/enccc_example>`__
...
Fabric repository to your $GOPATH/src/github.com/xianfuhui directory,
