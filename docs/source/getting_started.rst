...
in various programming languages. There are three smart contract SDKs available for Go, Node.js, and Java:
  ...
  * `Go SDK <https://github.com/xianfuhui/fabric/tree/release-1.4/core/chaincode/shim>`__ and `Go SDK documentation <https://godoc.org/gopkg.in/hyperledger/fabric.v1/core/chaincode/shim>`__.
  * `Node.js SDK <https://github.com/xianfuhui/fabric-chaincode-node>`__ and `Node.js SDK documentation <https://hyperledger.github.io/fabric-chaincode-node/>`__.
  * `Java SDK <https://github.com/xianfuhui/fabric-chaincode-java>`__ and `Java SDK documentation <https://hyperledger.github.io/fabric-chaincode-java/>`__.
...
in various programming languages. There are two application SDKs available for Node.js and Java:
  ...
  * `Node.js SDK <https://github.com/xianfuhui/fabric-sdk-node>`__ and `Node.js SDK documentation <https://fabric-sdk-node.github.io/>`__.
  * `Java SDK <https://github.com/xianfuhui/fabric-gateway-java>`__ and `Java SDK documentation <https://fabric-gateway-java.github.io/>`__.
...
(for Python and Go), but they are still available for downloading and testing:
  ...
  * `Python SDK <https://github.com/xianfuhui/fabric-sdk-py>`__.
  * `Go SDK <https://github.com/xianfuhui/fabric-sdk-go>`__.
