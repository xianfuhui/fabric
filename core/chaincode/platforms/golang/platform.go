...
import (
	...
	"github.com/xianfuhui/fabric/core/chaincode/platforms/util"
...
func (goPlatform *Platform) GetDeploymentPayload(path string) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/xianfuhui/fabric/core/chaincode/shim": true,
		"github.com/xianfuhui/fabric/protos/peer":         true,
	}
	...
	for _, file := range files {
		...
		// original file.Name:  src/github.com/xianfuhui/fabric/examples/chaincode/go/marbles02/META-INF/statedb/couchdb/indexes/indexOwner.json
