...
import (
	...
	"github.com/xianfuhui/fabric/core/chaincode/lifecycle/mock"
	"github.com/xianfuhui/fabric/core/chaincode/shim"
	lb "github.com/xianfuhui/fabric/protos/peer/lifecycle"
...
var _ = Describe("SCC", func() {
	...
	Describe("Path", func() {
		It("returns the path", func() {
			Expect(scc.Path()).To(Equal("github.com/xianfuhui/fabric/core/chaincode/lifecycle"))
		})
	})
